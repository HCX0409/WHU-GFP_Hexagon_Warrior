...
# 插入流程图
doc.add_picture('d:/GFP_Hexagon_Warrior/流程图.png', width=Cm(15))
...
doc.add_picture('d:/GFP_Hexagon_Warrior/项目导图.png', width=Cm(15))
last_paragraph = doc.paragraphs[-1]
last_paragraph.alignment = WD_ALIGN_PARAGRAPH.CENTER
caption = doc.add_paragraph()
caption.alignment = WD_ALIGN_PARAGRAPH.CENTER
...
if os.path.exists('d:/GFP_Hexagon_Warrior/V7预测能力.png'):
    doc.add_picture('d:/GFP_Hexagon_Warrior/V7预测能力.png', width=Cm(14))
    last_paragraph = doc.paragraphs[-1]
    last_paragraph.alignment = WD_ALIGN_PARAGRAPH.CENTER
    caption = doc.add_paragraph()
    caption.alignment = WD_ALIGN_PARAGRAPH.CENTER
...
if os.path.exists('d:/GFP_Hexagon_Warrior/v9_scatter_uniform.png'):
    doc.add_picture('d:/GFP_Hexagon_Warrior/v9_scatter_uniform.png', width=Cm(14))
    last_paragraph = doc.paragraphs[-1]
    last_paragraph.alignment = WD_ALIGN_PARAGRAPH.CENTER
    caption = doc.add_paragraph()
    caption.alignment = WD_ALIGN_PARAGRAPH.CENTER
...
# ======================== 保存 ========================
out_path = 'd:/GFP_Hexagon_Warrior/GFP_Hexagon_Warrior_技术文档_v9.docx'
doc.save(out_path)
